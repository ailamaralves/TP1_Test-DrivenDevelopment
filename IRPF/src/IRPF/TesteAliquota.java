...
public class TesteAliquota {
	...
	public TesteAliquota(Object[][] rendimentos, Object[][] deducoes, Object[][] dependentes, float valorEsperado) {
	...
	@Test
	public void testeAliquota() throws DescricaoEmBrancoException, ValorRendimentoInvalidoException, NomeEmBrancoException, ValorDeducaoInvalidoException {
		...
		assertEquals(valorEsperado, irpf.calcularAliquota(), 0f);
	}
